...
////////////////////////////////////collapsable archgraph/////////////////////////////////////////////
  ...
  if(document.getElementById("graphView")){//if graph veiw currently exists
...
var margin = {top: 20, right: 0, bottom: 20, left: 0},
 ...
 function update(source) {
   ...
   nodeEnter.append("circle")
       ...
       for (var gElement = 0; gElement<allGElements.length; gElement++){//for each g element (each node)

        if (!(allGElements[gElement] === null)) {//while it isn't null

          //select that specific g
          currentSelection=  d3.select(allGElements[gElement]);

          //if it's givens length isn't 0
          if (!allGElements[gElement].__data__.model.model.Givens.length ==0){

            for (var given = 0; given<allGElements[gElement].__data__.model.model.Givens.length;given++){ //for each one append it next to the node
    ...
    //for each node append the show statement
